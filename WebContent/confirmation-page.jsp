...
<%
	Car tempCar = (Car) session.getAttribute("tempCar");
%>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="container mainForm">
		<div class="row">
			...
			<div class="col-6 placeBorderHere">
				<h1 class="fancyTitle">Thank you!</h1>
				<p>Below are the details of your submission.</p>
				<img alt="" width="100%" height="50%" src="img/${tempCar.imagePath}">
				<div class="carDetails">
					<p>
						<strong>Make: </strong>
						<%
							out.print(tempCar.getMake());
						%>
					</p>
					<p>
						<strong>Model: </strong>
						<%
							out.print(tempCar.getModel());
						%>
					</p>
					<p>
						<strong>Year: </strong>
						<%
							out.print(tempCar.getYear());
						%>
					</p>
					<p>
						<strong>Mileage: </strong>
						<%
							out.print(tempCar.getMileage());
						%>
					</p>
					<p>
						<strong>Price: </strong>$<%
							out.print(tempCar.getPrice());
						%>
					</p>
					<p>
						<strong>Description: </strong>
						<%
							out.print(tempCar.getDescription());
						%>
					</p>
					<a href="http://localhost:8080/ServletTutorial/home" type="button"
								class="btn btn-primary float-right">Return</a>
