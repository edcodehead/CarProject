	...
	<header>
		...
		<div class="navbar navbar-dark bg-dark shadow-sm">
			<div class="container d-flex justify-content-between">
				<a href="http://localhost:8080/ServletTutorial/home" class="navbar-brand d-flex align-items-center">
	...
	<div class="container mainForm">
		<div class="row">
			...
			<div class="col-6 placeBorderHere">
				<h1 class="fancyTitle">Complete Order</h1>
				<p>Please enter your information to purchase this vehicle</p>
				...
				<form method="get" action="PurchaseFormServlet" name="buyForm"
					...
					<div class="form-group">
						<label for="buyerFirstName">First Name: </label> <input type="text"
							class="form-control" name="buyerFirstName" id="buyerFirstName"
					...
					<button type="submit" class="btn btn-primary">Submit</button>
						<a type="submit" class="btn btn-danger" href="http://localhost:8080/ServletTutorial/home"
						>Cancel</a>
